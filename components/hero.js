      ...
      <Container className="flex flex-wrap ">
        <div id='Home' className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              <span className="text-primary">NIFT</span>, <span className="text-primary">NID</span>, and <span className="text-primary">UCEED</span>
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              India's top institute for NIFT, NID, IIT (UCEED, CEED) preparation. Our distinguished alumni faculty guarantees expertise, ensuring your path to success.
            </p>
...
const CallNowButton = () => {
  ...
  return (
    <button onClick={handleCall} className="flex items-center space-x-2 text-gray-500 dark:text-gray-400">
      <svg 
        role="img"
        width="24"
        height="24"
